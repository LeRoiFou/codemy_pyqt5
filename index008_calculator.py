"""
PyQt5 - Codemy.com #008 : Build a Calculator With PyQT5 Designer - PyQt5 GUI Thursdays #8
Lien : https://www.youtube.com/watch?v=H1FpwbavWIk
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.arrowButton = QtWidgets.QPushButton(MainWindow, clicked= lambda: self.press_it("<<"))
        ...
        self.decimalButton = QtWidgets.QPushButton(MainWindow, clicked= lambda: self.press_it("."))
        ...
        self.equalButton = QtWidgets.QPushButton(MainWindow, clicked= lambda: self.press_it("="))
        self.equalButton.setGeometry(QtCore.QRect(275, 470, 75, 75))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.equalButton.setFont(font)
        self.equalButton.setObjectName("equalButton")
        self.plusminusButton = QtWidgets.QPushButton(MainWindow, clicked= lambda: self.press_it("+/-"))
    ...
    def press_it(self, pressed):
        ...
        if pressed == "C":  # si on appuye sur la touche 'C'
            self.outputLabel.setText("0")  # affichage du chiffre 0
        else: # sinon
            if self.outputLabel.text() == '0':  # si le chiffre '0' est déjà affiché
                self.outputLabel.setText("") # supprimer ce chiffre 0
