...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Bouton d'exécution
        self.my_button = QtWidgets.QPushButton(self.centralwidget, clicked=lambda:self.checked())
        self.my_button.setGeometry(QtCore.QRect(110, 140, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.my_label.setGeometry(QtCore.QRect(110, 210, 241, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
    ...
    def checked(self):
        ...
        "1ère possibilité : recourir à l'instruction isChecked()"
        ...
        "2ème possibilité : recourir à l'instruction checkState()"
