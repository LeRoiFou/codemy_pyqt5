"""
Cours : Add A Database To Our ToDo List part 1 - PyQt5 GUI Thursdays #14
Lien : https://www.youtube.com/watch?v=EqIArksYxYs

Dans ce programme on apprend à générer une liste des choses à faire à partir de l'application QtDesigner

Ce programme est la suite du cours n° 13, en complément on rajoute un bouton supplémentaire "Sauvegarder",
qui nécessite donc de revenir sur l'application QtDesigner pour générer à nouveau un programme en rajoutant
les méthodes saisies dans le cours n° 13.
Et en complément dans ce cours lorsqu'on appuye sur le bouton"Sauvegarder", les données saisies s'affichent dans la console
