"""
Cours #53 : Blackjack Five Card Win
Lien : https://www.youtube.com/watch?v=kwR6OLzti4M
            ...
            try:  
                ...
                if self.playerSpot == 0:
                    ...
                    if self.player_total <= 21:
                        ...
                        QMessageBox.about(self, 
                                          "Le joueur a gagné !",
                                          f"Joueur a gagné : {self.player_total} Croupier : {self.dealer_total}")
