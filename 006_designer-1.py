...
#
# Site pour lier Pycharm avec QtDesigner :
# https://www.youtube.com/watch?v=1CZ2RZ6ffRo
#
# Rajout des outils extérieurs QtDesigner dans Interpreteur Settings -> Tools -> External Tools :
# . Ajout 'QtDesigner' :
#     -> Program : C:\Users\LRCOM\PycharmProjects\codemy_pyqt5\venv\Lib\site-packages\QtDesigner\designer.exe
#     -> Working directory : $ProjectFileDir$
# . Ajout 'PyUIC' :
#     -> Program : C:\Users\LRCOM\PycharmProjects\codemy_pyqt5\venv\Scripts\pyuic5.exe
#     -> Arguments : $FileName$ -o $FileNameWithoutExtension$.py
#     -> Working directory : $FileDir$
#
# Touches utilisées sur l'application QtDesigner :
# CTRL + R : aperçu du résultat
#
# Rajout de la méthode spéciale if __name__ == "__main__" pour exécuter le programme :
